...
-- ============================================================
-- 1. Updated resolve_day_vote — prince check before kill
-- ============================================================
...
-- ============================================================
-- 2. RPC: advance_after_prince — host advances from prince_reveal to night
-- ============================================================
CREATE OR REPLACE FUNCTION public.advance_after_prince(p_room_id UUID)
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
